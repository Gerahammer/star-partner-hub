...
import goldPBg from "@/assets/gold-p-bg-v2.png";
  ...
  return (
    <div className="relative w-full h-full flex items-end justify-center">
      ...
      <img 
        src={goldPBg} 
        alt="" 
        className="absolute -top-16 -bottom-16 -right-8 left-8 w-[calc(100%+8rem)] h-[calc(100%+8rem)] object-contain opacity-60 pointer-events-none"
      />
